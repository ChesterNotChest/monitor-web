## Purpose
Defines the main application shell layout including collapsible sidebar navigation, breadcrumb navigation, layout structure, and alert badges for page routing.
