## Purpose
Renders the fence editor page with video placeholder in edit mode, fence zone list sidebar, point selection instruction, and action buttons for zone management.
